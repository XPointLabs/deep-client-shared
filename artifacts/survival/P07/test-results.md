...
- Full Release: 377 passed, 0 failed, 0 skipped.
- Focused `MembershipTrust`: 67 passed, 0 failed, 0 skipped.
- Privacy/source gate: 3 passed, 0 failed, 0 skipped.
- Schema/flags: 6 passed, 0 failed, 0 skipped.
- Full TRX SHA-256: `5bcf2841d187e2e94d4dee5391904628703bf54ad08fde6be816a2684ebb2d9f`.
- Focused TRX SHA-256: `23f468e45755f38d2856dfb58de76c79d51c47d4bd28b8046df14ed2727c1fea`.
- Schema/flags TRX SHA-256: `d8478da2e1182abd731d94b0068790a2fa903d3cfc93d903ad0dda17dee660a6`.

The commands above were run from exact source commit
`9e2ceb1ddf6353a84a3c62334b5a12ab58198a0d`. The dependency gate also
...
| `dotnet test .\tests\Deep.Client.Shared.Tests\Deep.Client.Shared.Tests.csproj --configuration Release --no-restore --filter "FullyQualifiedName~MembershipTrust" --logger "trx;LogFileName=p07-corrective4-focused.trx" --results-directory .\artifacts\survival\P07\trx` | 0 |
| `dotnet test .\Deep.Client.Shared.slnx --configuration Release --no-restore --logger "trx;LogFileName=p07-corrective4-full.trx" --results-directory .\artifacts\survival\P07\trx` | 0 |
| `& .\eng\scripts\Invoke-P07TrustGate.ps1` | 0 |
| `dotnet test .\tests\Deep.Client.Shared.Tests\Deep.Client.Shared.Tests.csproj --configuration Release --no-restore --filter "FullyQualifiedName~FeatureFlagsTests\|FullyQualifiedName~LogicalSchemaThreeToFour" --logger "trx;LogFileName=p07-corrective4-schema-flags.trx" --results-directory .\artifacts\survival\P07\trx` | 0 |
